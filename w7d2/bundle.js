...
document.addEventListener('DOMContentLoaded', function () {
  ...
  store = addMiddlewares(store, addLoggingToDispatch);
...
function applyMiddleswares(store, middlewares) {
  var dispatch = store.dispatch;
  middlewares.forEach(function (middleware) {
    dispatch = middleware(store)(dispatch);
  });
  return Object.assign({}, store, { displatch: displatch });
};
...
var silly = function silly(store) {
  return function (next) {
    console.log(next);
  };
};
